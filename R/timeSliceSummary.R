...
timeSliceSummary <- function(timeSliceObject, cutoff=4, AICc=TRUE, lowerBound=1e-8, upperBound=1000, 
  plot.phylo=TRUE, colour.ramp=c("blue", "red"), cex.plot=1, model.average = FALSE, ...) {
